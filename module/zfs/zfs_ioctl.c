 ...
 * snapshot chains.
 *
 * outnvl: the decide summary -- counts per conflict kind, the
 * quarantine and edit counts, and a bounded prefix of conflict
 * records with a truncated flag.  The full manifest streams through
 * an optional descriptor once the manifest issues land.
 */
